const ServiceData = {
    ...
    HRService: [
        {
            id: '1',
            HRtitles : 'Terms and conditions',
            HRdescription: '',
            Hicon: 'panel',
            rclass : 'pr_70',
            iclass: 'icon_one',
            iconUrl: `${require ("../../img/court.svg")}`,
        },
        {
            id: '2',
            HRtitles : 'Data protection',
            HRdescription: '',
            Hicon: 'layout-grid2',
            rclass : 'pl_50 pr_20',
            iclass: 'icon_two',
            iconUrl: `${require ("../../img/data-security.svg")}`,
        },
        {
            id: '3',
            HRtitles : 'Contracts',
            ...
            rclass : 'pl_70',
            iclass: 'icon_three',
            iconUrl: `${require ("../../img/contract.svg")}`,
        },
        {
            id: '4',
            ...
            rclass : 'pr_70',
            iclass: 'icon_four',
            iconUrl: `${require ("../../img/electronics.svg")}`,
        },
        {
            id: '5',
            HRtitles : 'Immigration',
            HRdescription: '',
            Hicon: 'cloud-down',
            rclass : 'pl_50 pr_20',
            iclass: 'icon_five',
            iconUrl: `${require ("../../img/passport.svg")}`,
        },
        {
            id: '6',
            HRtitles : 'Taxes',
