    ...
    <div className="fixed-service custom-fix-fee-service">
      <div className="header bg-white">
        <a style={{color: '#4b505e'}}
          ...
          <div className="line-height-1-5"><b>Area of law:</b> {props.category}</div>
          <div className="line-height-1-5"><b>Delivrable:</b> {props.deliveryTime && (props.deliveryTime.amount + " " + props.deliveryTime.unit + " consultation")}</div>
        </a>
      </div>
      <div className="body">
        <div className="row mt-3">
            <div className="col-md-7">
              ...
              <p className="subtitle">{props.lawyer.title}</p>
