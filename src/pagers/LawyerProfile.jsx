...
import { Switch, Route, NavLink, Link, useRouteMatch, withRouter } from "react-router-dom";
          ...
          <div className="container pb-4">
            ...
            <div className="row mx-0 align-items-center">
              <div className="col-sm-12 px-0 d-flex lawyer-card-large">
                <div>
                  <img src={this.props.userInfo.profilePic || pic} className="img-pic-user-large mr-4" alt="user_pic" />
                </div>
                <div className="mt">
