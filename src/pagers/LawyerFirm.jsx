...
export class LawyerFirm extends Component {
              ...
              <div className="col-sm-12 px-0 lawyer-card-large">
                <div className="row">
                  ...
                  <div className="col-md-9 com-sm-12">
                      <div className="row">
                        { this.state.copied ? (<span className="copied-success">Lowyer firm URL Copied!</span>) : ''}
          ...
          <div className="row">
            <div className="col-sm-12 px-0">
              <div className="mt-3 mt-5-mobile relative-position">
                <NavLink activeClassName="selected" className="toplink mobile-toplink" to={`${url}/people`}>People</NavLink>
                <NavLink activeClassName="selected" className="toplink mobile-toplink" to={`${url}/fixed-services`}>Services</NavLink>
                <NavLink activeClassName="selected" className="toplink mobile-toplink" to={`${url}/industries`}>Industries</NavLink>
                <NavLink activeClassName="selected" className="toplink mobile-toplink" to={`${url}/fees`}>Fees</NavLink>
                <NavLink activeClassName="selected" className="toplink mobile-toplink" to={`${url}/about`}>About us</NavLink>
              </div>
